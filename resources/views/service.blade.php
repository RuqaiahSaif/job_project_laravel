        ...
        <div class="row my-5">
            <div class="col-md-4 col-sm-12">
                <div class="card" style="width: 18rem; border:1px  solid #f4931e;">
                    <img src="images/serv1.png" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card" style="width: 18rem;border:1px  solid #a91e22;">
                    <img src="images/serv2.png" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card" style="width: 18rem;border:1px  solid #3fba8c;">
                    <img src="images/serv3.png" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
