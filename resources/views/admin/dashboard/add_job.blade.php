...
<div class="card mb-4">
 ...
 <div class="col-md-6">
        <label class="form-label" for="multicol-username">job Location </label>
        <input name="name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
       ...
       <div class="col-md-6">
        <label class="form-label" for="multicol-username">JRef. Number</label>
        <input name="name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        ...
        <div class="col-md-6">
        <label class="form-label" for="multicol-username">Date Posted</label>
        <input name="name" type="date" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Closing on</label>
        <input name="name" type="date" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
