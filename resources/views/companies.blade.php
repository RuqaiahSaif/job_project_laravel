        ...
        <div class="row mt-2 ">
            <div class="col-md-3 col-sm-12">
                <div class="card p-2">
                    ...
                    <div class="text-center mt-2 p-3"> <img src="images/Capture.png" alt="" class="img-fluid"> <span
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card p-2">
                    <!-- <div class="text-right"> <small>Full Time</small> </div> -->
                    <div class="text-center mt-2 p-3"> <img src="images/Injaz_Logo.png" alt="" class="img-fluid"> <span
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card p-2">
                    <!-- <div class="text-right"> <small>Full Time</small> </div> -->
                    <div class="text-center mt-2 p-3"> <img src="images/telcom.jpg" alt="" class="img-fluid"> <span
